...
(function ($) {
    ...
    function setIFrameHeight() {
        ...
        // Set iframe height
        $('#plone-notifications', window.parent.document)
    ...
    $.plone.notify = function (options) {
        ...
        if ($('.overlay', window.parent.frames['plone-toolbar'].document).length !== 0) {
            $('#plone-notifications', window.parent.document)
                .css('left', $(window.parent.frames['plone-toolbar']).width() - 320);
        } else {
            $('#plone-notifications', window.parent.document)
